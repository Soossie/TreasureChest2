...
alter table difficulty add column advice_guy_reward int(11);

alter table difficulty add column advice_guys_in_countries int(11);

alter table difficulty add column advice_guys_in_airports int(11);

alter table game_airports add column has_advice_guy int(11);

alter table game_airports add column visited int(11);

alter table game add column co2_consumed int(11);

update difficulty
set advice_guy_reward = 100, advice_guys_in_countries = 4, advice_guys_in_airports = 2
where level = "easy";

update difficulty
set advice_guy_reward = 250, advice_guys_in_countries = 8, advice_guys_in_airports = 4
where level = "normal";

update difficulty
set advice_guy_reward = 500, advice_guys_in_countries = 16, advice_guys_in_airports = 8
where level = "hard";
